    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.bm = diffrax.VirtualBrownianTree(
            t0=0.0, t1=199.0, tol=1.0 / 2, shape=(noise_size,), key=bm_key
        )
...
def train(
    ...
    print(f"unroll: {unroll1}, compiel_time: {compile_time}, run_time: {run_time * 50}, total_time: {compile_time + run_time * 50}")
...
def main():
    ...
    parser.add_argument('--unroll1', type=int, default=200)
    parser.add_argument('--unroll2', type=int, default=1)
    parser.add_argument('--t0', type=float, default=0.0, required=False)
    parser.add_argument('--t1', type=float, default=199.0, required=False)
    # test code
